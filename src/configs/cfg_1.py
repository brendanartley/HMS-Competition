...
cfg.backbone_comp= "hgnetv2_b2.ssld_stage2_ft_in1k"
cfg.backbone= "hgnetv2_b4.ssld_stage2_ft_in1k"
...
stft_config.stft_n_fft=110       # height
stft_config.stft_win_length=64   # width
stft_config.stft_hop_length=23   # width
stft_config.stft_trainable=True
stft_config.stft_stack_factor= 2
stft_config.stft_fmax= 40.0
stft_config.stft_window= "cosine"
